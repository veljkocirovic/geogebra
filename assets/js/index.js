...
app.loadPartials([
    { id: '#nav', path: consts.partialsPath + 'navigation.partial.html', script: consts.assetsPath + 'js/navigation.js' },
    { id: '#footer', path: consts.partialsPath + 'footer.partial.html', script: consts.assetsPath + 'js/footer.js' },
]);
